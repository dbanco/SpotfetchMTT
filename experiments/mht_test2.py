...
from mtt_framework.mht_tracker import visualize_hypothesis_tree
...
visualize_hypothesis_tree(mht_tracker.tree.root)
...
for t in range(1, len(data)):
    ...
    for measurement in measurements: print(measurement.com)
    ...
    mht_tracker.update_hypothesis_tree(measurements)
    ...
    # mht_tracker.generate_hypotheses()
