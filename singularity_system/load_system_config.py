...
print(f'export SIF_DIR="{os.path.join(sing_dir, sys_cfg["sif_dir"])}"')
print(f'export APP_DIR="{os.path.join(sing_dir, sys_cfg["app_dir"])}"')
print(f'export DB_NAME="{sys_cfg["db_name"]}"')
print(f'export POSTGRES_DIR={os.path.join(sing_dir, sys_cfg["postgres_dir"])}')
print(f'export REGION_DIR={os.path.join(sing_dir, sys_cfg["region_dir"])}')
print(f'export TRACKER_STATE_DIR={os.path.join(sing_dir, sys_cfg["tracker_state_dir"])}')
